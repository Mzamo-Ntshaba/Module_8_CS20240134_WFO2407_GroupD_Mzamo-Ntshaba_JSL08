...
const branchA = new BankBranch('Shop 1043 Mall of Africa , Magwa Cres, Midrand, 1685');
...
console.log(branchA === branchB ? 'True (Both variables reference the same instance)': 'False (The variables do not reference the same instance)');
